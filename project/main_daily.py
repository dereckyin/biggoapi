...
def update_product(batch_date: str, end_date: str):
    ...
    with YahooApiDao() as master_dao:
        ...
        master_dao.get_biggo_prod_main_daily(batch_date, end_date)
            ...
            for chunk in chunks:
                ...
                for item in chunk:
                    my_obj = {
                        ...
                        "prod_sale_qty":item["SALE_QTY"],
                        "prod_sale_qty_30":item["SALE_QTY_30"],
                        "prod_sale_qty_7":item["SALE_QTY_7"],
...
if __name__ == '__main__':
    settingLog()
    update_product('20221113', '20221114')